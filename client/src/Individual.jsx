...
gsap.from(".Box h4 .a",{
 ...
 gsap.from(".Box h4 .b",{
  ...
  const socket=useMemo(()=>io("https://web-socket-chat-app-5-backend.onrender.com",{query:{userId}}),[]);  //tries to create a persistent connection between client to server , using useMemo() causes no re-rendering when some update is done in the state and hooks ,, but this will start afresh when the app is refreshed ,,
